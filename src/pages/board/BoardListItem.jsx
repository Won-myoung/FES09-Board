...
BoardListItem.propTypes = {
  item: PropTypes.object.isRequired//실수로 아이템을 넘겨주지 않으면 아래코드로 내려가기 전 error를 만들어 디버깅 하기 좋게
};
...
function BoardListItem({ item }){
  ...
  return (
    <tr className="border-b border-gray-200 hover:bg-gray-200 dark:hover:bg-gray-500 transition duration-300 ease-in-out">
